...
import { flattenTree, findFocusIndex } from './flatten-tree.js';
import type { FlatRow, FlatFileRow, FlatDirRow } from './flatten-tree.js';
...
describe('findFocusIndex', () => {
  ...
  it('returns correct index for matching directory path', () => {
    ...
    const rows: FlatRow[] = [
      { type: 'directory', depth: 0, node: dir, expanded: true, parentPath: null },
      { type: 'file', depth: 0, node: fileA, parentPath: null },
    ];
